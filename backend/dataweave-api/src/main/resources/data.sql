...
(46, 'TOOL', 'QUALITY_RULE_WRITE',      NULL, 'L1', '质量断言定义写（租户内例行，直通+审计）',           1, 20, 1, 1, TIMESTAMP '2026-06-01 00:00:00', TIMESTAMP '2026-06-01 00:00:00', 0, 0),
(47, 'TOOL', 'QUALITY_RUN',             NULL, 'L2', '质量 on-demand 触发（真连业务库读副作用，需审批）', 1, 20, 1, 1, TIMESTAMP '2026-06-01 00:00:00', TIMESTAMP '2026-06-01 00:00:00', 0, 0);
