...
public record ExecutionContext(String content, String bizDate, int attempt, int timeoutSeconds,
     ...
     * @param memoryMb   069：声明式内存提示（MB，driver/executor 同值）；null=引擎默认
     * @param cpuCores   069：声明式 CPU 核数提示（driver/executor 同值）；null=引擎默认
     */
     ...
     * @param memoryMb   069：声明式内存提示（MB，Flink taskmanager/DataX·SeaTunnel JVM 堆）；null=引擎默认
     * @param cpuCores   069：声明式 CPU 核数提示（Flink taskmanager slot 数参考）；null=引擎默认
     */
    public record EngineSubmitRef(String kind, String engineHome, String mode, String jarPath,
        ...
        /** 向后兼容构造（无 long_running/external_job_handle/savepoint/069 资源字段，默认 false/null/null/null/null）。 */
        ...
        /** 062 向后兼容构造（含 long_running/external_job_handle，无 savepoint/069 资源字段）。 */
        public EngineSubmitRef(String kind, String engineHome, String mode, String jarPath,
                              String mainClass, String configPath, Map<String, String> props,
                              boolean longRunning, String externalJobHandle) {
        ...
        /** D2 向后兼容构造（含 savepoint 恢复路径，无 069 资源字段）。 */
        public EngineSubmitRef(String kind, String engineHome, String mode, String jarPath,
                              String mainClass, String configPath, Map<String, String> props,
